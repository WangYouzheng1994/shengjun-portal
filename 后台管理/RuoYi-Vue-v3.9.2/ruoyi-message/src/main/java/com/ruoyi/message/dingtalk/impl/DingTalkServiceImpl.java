package com.ruoyi.message.dingtalk.impl;

import com.alibaba.fastjson2.JSON;
import com.alibaba.fastjson2.JSONObject;
import com.ruoyi.message.config.DingTalkConfig;
import com.ruoyi.message.domain.MessageResult;
import com.ruoyi.message.dingtalk.DingTalkService;
...
public class DingTalkServiceImpl implements DingTalkService {
    ...
    @Override
    public MessageResult sendWorkNotice(String userIdList, String title, String content) {
    ...
    @Override
    public MessageResult sendWorkNoticeMarkdown(String userIdList, String title, String markdown) {
        if (!dingTalkConfig.isEnabled()) {
            return MessageResult.fail("NOT_ENABLED", "钉钉对接未启用");
        }
    ...
    @Override
    public MessageResult sendWorkNoticeToAll(String title, String content) {
        return sendWorkNotice("", title, content);
    }
