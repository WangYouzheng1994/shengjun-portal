...
-- 三级菜单：公告管理（属于信息发布）
INSERT INTO `sys_menu`(`menu_name`, `parent_id`, `order_num`, `path`, `component`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`)
VALUES('公告管理', @articleDirMenuId, 3, 'notice', 'portal/notice/index', 'C', '0', '0', 'portal:notice:list', 'message', 'admin', sysdate(), '', null, '公告管理菜单');
...
INSERT INTO `sys_menu`(`menu_name`, `parent_id`, `order_num`, `path`, `component`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`)
SELECT '企业荣誉墙', @baseMenuId, 3, 'companyHonor', 'portal/base/companyHonor/index', 'C', '0', '0', 'portal:base:honor:list', 'trophy', 'admin', sysdate(), '', null, '企业荣誉墙菜单'
...
-- 二级菜单：产品列表
INSERT INTO `sys_menu`(`menu_name`, `parent_id`, `order_num`, `path`, `component`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`)
SELECT '产品列表', @productDirId, 1, 'list', 'portal/product/list/index', 'C', '0', '0', 'portal:product:list', '#', 'admin', sysdate(), '', NULL, '产品列表菜单'
...
-- 二级菜单：产品分类
INSERT INTO `sys_menu`(`menu_name`, `parent_id`, `order_num`, `path`, `component`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`)
SELECT '产品分类', @productDirId, 2, 'category', 'portal/product/category/index', 'C', '0', '0', 'portal:productCategory:list', '#', 'admin', sysdate(), '', NULL, '产品分类菜单'
...
-- 二级菜单：品牌管理
INSERT INTO `sys_menu`(`menu_name`, `parent_id`, `order_num`, `path`, `component`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`)
SELECT '品牌管理', @productDirId, 3, 'brand', 'portal/product/brand/index', 'C', '0', '0', 'portal:productBrand:list', '#', 'admin', sysdate(), '', NULL, '品牌管理菜单'
...
-- 二级菜单：属性模板
INSERT INTO `sys_menu`(`menu_name`, `parent_id`, `order_num`, `path`, `component`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`)
SELECT '属性模板', @productDirId, 4, 'template', 'portal/product/template/index', 'C', '0', '0', 'portal:productAttrTemplate:list', '#', 'admin', sysdate(), '', NULL, '属性模板菜单'
...
INSERT INTO `sys_menu`(`menu_name`, `parent_id`, `order_num`, `path`, `component`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`)
SELECT '企业发展历程', @baseMenuId, 4, 'companyMilestone', 'portal/base/companyMilestone/index', 'C', '0', '0', 'portal:base:milestone:list', 'time-line', 'admin', sysdate(), '', null, '企业发展历程菜单'
