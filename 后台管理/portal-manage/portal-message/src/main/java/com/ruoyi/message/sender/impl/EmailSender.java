package com.ruoyi.message.sender.impl;
...
public class EmailSender implements MessageSender {
    ...
    public MessageResult sendText(String receiver, String content) {
        log.info("邮件发送功能待实现，接收者：{}，内容：{}", receiver, content);
        return MessageResult.fail("NOT_IMPLEMENTED", "邮件发送功能待实现");
    }

    @Override
    public MessageResult sendRichText(String receiver, String title, String content, String url) {
        log.info("邮件发送功能待实现，接收者：{}，标题：{}，内容：{}，链接：{}", receiver, title, content, url);
        return MessageResult.fail("NOT_IMPLEMENTED", "邮件发送功能待实现");
    }
}
